...
/**
 * Chicago Style Activity class that controls the GUI for the Chicago Style
...
public class ChicagoStyleActivity extends AppCompatActivity {
    ...
    private Topping[] toppings = {Topping.GREENPEPPER, Topping.ONION, Topping.MUSHROOM,
            Topping.PINEAPPLE, Topping.BLACKOLIVES, Topping.SAUSAGE, Topping.BBQCHICKEN,
            Topping.PROVOLONE, Topping.CHEDDAR, Topping.BEEF, Topping.HAM, Topping.PEPPERONI,
            Topping.SPINACH};
    ...
    /**
     * Sets up the screen of the Chicago Style Pizza
     */
    private void initializeValues() {
        this.Order = MainActivity.order;
        this.StoreOrder = MainActivity.storeOrder;
        image = (ImageView) findViewById(R.id.chicagoImage);

        price = (TextView) (findViewById(R.id.price));
        crust = (TextView) (findViewById(R.id.crust));

        smallSize = (RadioButton) (findViewById(R.id.radioButtonSmall));
    ...
    private void initializeListViews() {
        ...
        toppingAvailableAdapter = new ArrayAdapter<Topping>(this,
        ...
        toppingSelectedAdapter = new ArrayAdapter<Topping>(this,
    ...
    /**
     * Listener for the spinner. If a different pizza is selected, then it set the new pizza's
     * fields correctly
     */
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView,
                ...
                if (selectedPizzaType.equals("Deluxe")) {
                    ...
                    pizza = pizzaFactory.createBuildYourOwn();
                    image.setImageResource(R.drawable.chicagobyo);
    ...
    private void addToOrder() {
        addOrder = (Button) findViewById(R.id.addOrderButton);
        addOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedToppings.size() == 0) {
                    ...
                    Order.add(pizza);
                    Order.addToStringArray(pizza, "Chicago Style");
